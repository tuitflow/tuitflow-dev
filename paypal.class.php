...
class paypal_class {
   ...
   function paypal_class() {
     ...
     // $this->paypal_url = 'https://www.paypal.com/cgi-bin/webscr';
      $this->paypal_url = 'https://paypal.com/cgi-bin/webscr';
      $this->last_error = '';
   ...
   function submit_paypal_post() {
      ...
      echo "<center><h2>Por favor espera, tu pago se esta procesando";
      echo ".</h2></center>\n";
      ...
      echo "<center><br/><br/>Si pasados unos segundos no accede a PayPal...<br/><br/>\n";
